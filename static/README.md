...
## Frontend-parannukset (Bonus):
- Lisää latausanimaatiot
- Vahvista ostokset modaalilla confirm()-dialogin sijaan
- Lisää filter/search-toiminnot pitkille listoille
- Responsive-testaus mobiililla (Ihan extraa)
